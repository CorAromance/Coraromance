...
const testimonials = [
  {
    name: "Мария К.",
    text: "Baccarat Rouge 540 нечто невероятное. Шлейф держится весь день, комплименты не прекращаются. Консультация в Telegram помогла выбрать идеальную концентрацию.",
    rating: 5
  },
  {
    name: "Михаил К.",
  ...
  {
    name: "Екатерина Л.",
    text: "Initio Atomic Rose превзошёл все ожидания. Мощный, роскошный, провокационный. Бутик провел качественную консультацию и ответил на все вопросы!",
    rating: 5
  }
];
            ...
            >
              ...
              >
                ...
                >
                  ...
                  — бутик нишевой парфюмерии в Ростове-на-Дону. Мы создаём пространство,
                ...
                >
                  ...
                  >
                    <p style={{ color: "var(--natural-titanium)", opacity: 0.85 }}>
                      Персональные консультации в Telegram • Доставка по всей России
                    </p>
                  </div>
                </motion.div>
              </div>
